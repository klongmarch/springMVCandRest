use password "fun123" for all the users.
usernames: 'john', 'mary', 'susan' 
above users have different roles. And different action shows up.
...
This app uses Spring Boot, Spring Security (JDBC), Thymeleaf, Spring Data JPA
